...
public class CfmArrival extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cfm_arrival);
            ...
            public void onClick(View v) {
                ...
                else
                {
                    try {
                        ...
                        result = new MakeNetworkCall().execute("ConfirmArrival",
                    ...
                    if (result.equals("Success"))
                    {
                        ...
                        toast.show();
                        Intent i = new Intent(CfmArrival.this, HomeActivity.class);
                        startActivity(i);
                        finish();
                    }
                    else
